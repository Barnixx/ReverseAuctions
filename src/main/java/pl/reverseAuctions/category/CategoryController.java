...
public class CategoryController {
    ...
    public String getCategory(Model model, @PathVariable long category_id) {
        ...
        model.addAttribute("auctionsList", auctionService.getAuctionsByCategoryId(category_id));
        return "auctionList";
    }
    ...
    public String getCategory(Model model, @PathVariable long category_id,
        ...
        model.addAttribute("subcategoriesMap", categoryService.getAllCategoriesWithSubcategories());
        model.addAttribute("auctionsList", auctionService.getAuctionsBySubcategoryId(subcategory_id));
        return "auctionList";
    }
}
